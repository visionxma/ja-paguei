...
CREATE POLICY "Members can view group" ON public.groups FOR SELECT TO authenticated
USING (is_group_member(id));

CREATE POLICY "Authenticated can create groups" ON public.groups FOR INSERT TO authenticated
WITH CHECK (auth.uid() = created_by);

CREATE POLICY "Members can update group" ON public.groups FOR UPDATE TO authenticated
USING (is_group_member(id));
...
CREATE POLICY "Members can view members" ON public.group_members FOR SELECT TO authenticated
...
CREATE POLICY "Members can remove themselves" ON public.group_members FOR DELETE TO authenticated
...
CREATE POLICY "Members can view invites" ON public.group_invites FOR SELECT TO authenticated
USING (is_group_member(group_id));
...
CREATE POLICY "Members can delete invites" ON public.group_invites FOR DELETE TO authenticated
USING (is_group_member(group_id));
